...
=====================================================================
SUBAGENTE: review-code
=====================================================================

Description

Especialista em revisão de aplicações na linguagem utilizada no projeto.

Objetivo

Revisar componentes verificando aderência às boas práticas do framework, ciclo de vida dos componentes e padrões recomendados.
...
- item por elemento utilizado no projeto

Considere as melhores práticas de desenvolvimento Web App.
